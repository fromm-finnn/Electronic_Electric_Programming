...
/*-------------------------------------------- calculate the root of quardratic equation --------------------------------------------*/
...
//
//		printf("%.0fx^2 + %.0fx + %.0f = 0's roots are [%.3f, %.3f]:", a, b, c, x1, x2);
//	}
//
//	if (Discriminant(a, b, c) < 0)
//	{
//		x1 = -b / (2 * a);
//
//		x2 = sqrt(-Discriminant(a, b, c)) / (2 * a);
//		
//		printf("%.0fx^2 + %.0fx + %.0f = 0's roots are [%.3f + %.3fi, %.3f - %.3fi]:", a, b, c, x1, x2, x1, x2);
//	}
//
//	return 0;
//}
...
//	double a, b, c;
//
//	printf("Input the coefficient(a,b,c) of ax^2 + bx + c = 0\n");
